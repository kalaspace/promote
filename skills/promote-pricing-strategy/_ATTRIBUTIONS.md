# Attribution — promote-pricing-strategy

**Nom d'origine** : `pricing-strategy`
**Source publique** : coreyhaines31/marketingskills (SaaS pricing strategy)
**Date d'import** : 2026-04-28
**Renommé en** : `promote-pricing-strategy` (préfixe `promote-` pour éviter les collisions de namespace)
**Frontmatter `name:` modifié** : oui (de `pricing-strategy` à `promote-pricing-strategy`)
